...
export function UHNISection({ className }: { className?: string; }) {
  ...
  return (
    <section
      id="uhni"
      className={cn(
        "relative w-full overflow-hidden bg-brand-cream px-4 py-24 md:px-12 md:py-32 lg:px-16 lg:py-40",
        className,
      )}
      aria-labelledby="uhni-section-heading"
    >
      <div className="relative mx-auto w-full max-w-[1400px]">
        <div className="overflow-hidden rounded-xl border-[1.5px] border-brand-navy/20 bg-white/60 p-8 md:p-12 lg:p-16">
          ...
          <Reveal delay={0.24} className="mt-12 md:mt-16">
            <div className="relative aspect-[21/9] w-full overflow-hidden rounded-xl border-[1.5px] border-brand-navy/20 bg-brand-cream">
              {!imageFailed ? (
                <Image
          ...
          <Reveal delay={0.32} className="mt-12 md:mt-16">
            ...
            {/* Cleaned layout wrapper utilizing grid gaps as uniform inner borders */}
